...
object DestinationRoute {
    ...
    const val SETTING_USER_MANAGER_ROUTE = "SETTING_USER_MANAGER_ROUTE"
    const val SETTING_SHOP_ROUTE = "SETTING_SHOP_ROUTE"
    const val SETTING_ROUTE = "SETTING_ROUTE"
    const val CAISSE_SEE_ALL_ROUTE = "CAISSE_SEE_ALL_ROUTE"
    const val CAISSE_ACCOUNT_ROUTE = "CAISSE_ACCOUNT_ROUTE"
    const val CAISSE_TRANSFER_ROUTE = "CAISSE_TRANSFER_ROUTE"
    const val CAISSE_SORTIE_ROUTE = "CAISSE_SORTIE_ROUTE"
    const val CAISSE_ENTER_ROUTE = "CAISSE_ENTER_ROUTE"
    const val CAISSE_ROUTE = "CAISSE_ROUTE"
    const val PROVIDER_ROUTE = "PROVIDER_ROUTE"
    const val NEW_PRODUCT_ROUTE = "NEW_PRODUCT_ROUTE"
    const val ADD_PRODUCT_IN_STORE_ROUTE = "ADD_PRODUCT_IN_STORE_ROUTE"
    const val STORE_ROUTE = "STORE_ROUTE"
    const val NEW_CLIENT_ROUTE = "NEW_CLIENT_ROUTE"
    const val NEW_FACTURE_ROUTE = "NEW_FACTURE_ROUTE"
    const val CLIENT_ROUTE = "CLIENT_ROUTE"
    const val FACTURATION_ROUTE = "FACTURATION_ROUTE"
